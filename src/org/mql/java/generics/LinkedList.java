...
//pour la recursivite il faut 3 conditions l'equation du recursivite /condition d'arret/confiance
public class LinkedList<T> implements List<T> ,Iterable<T>{
	...
	public void add(T e) {
			...
			else if(next==null) next =new LinkedList<T>(e);//cree un noeud et pose en next//ajouter un element ala fin
